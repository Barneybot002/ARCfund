 ...
 */
export async function encryptWithArcium(data) {
 ...
 */
export async function decryptWithArcium(encryptedData, accessToken) {
 ...
 */
export async function requestProjectAccess(projectId, investorAddress) {
