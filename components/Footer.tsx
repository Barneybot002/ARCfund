/**
 * Footer Component - Footer with Arcium attribution
 */
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-2">
                        ...
                        <p className="text-gray-400 mb-6 max-w-md">
                            Private fundraising platform powered by Arcium&aposs confidential computing technology.
                            Protect your vision while raising funds.
                        </p>
                        <ArciumBadge />
                    </div>
                ...
                <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <p className="text-gray-500 text-sm">
                        © {currentYear} ARCfund. Built with Arcium MXE.
                    </p>
                    <div className="flex gap-6">
                        ...
                        <a href="https://discord.com/invite/arcium" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-purple-400 transition-colors">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
